...
AI''. They will be further covered in the next section (Section \ref{sec:biology-inspired-ai}).
...
\marginpar{Expand this section to be a general overview of inductive
  programming}
...
\marginpar{Make this section only cover ADATE, remove all "general" info about
  inducive programming}
...
\marginpar{Insert explanation of the previous work and some reasons for basing
  this thesis on it here}
